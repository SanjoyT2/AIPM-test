...
const FDE: M[] = [
  { title: "Week 1 — Problem, People & GenAI Foundations", comps: ["L1.GENAI.PROMPTING", "L4.DOMAIN.DISCOVERY"],
    human_spine: "Commit to one real business problem + a real stakeholder; first empathy map + stakeholder map; run a discovery interview; write the problem in the stakeholder's words with a success metric.",
    milestone: { title: "Repo live + first working LLM assistant", definition_of_done: "GitHub repo exists; a first LLM assistant against the brief is committed." },
    lessons: [
  ...
  { title: "Week 2 — Prompt Engineering & Building with AI", comps: ["L1.GENAI.PROMPTING", "L2.CLAUDE.WORKFLOWS"],
    human_spine: "Feedback loop 1 — validate the direction with the stakeholder.",
    milestone: { title: "v1 of the core logic on GitHub", definition_of_done: "The solution's core logic v1 is committed with clean history." },
    lessons: [
  ...
  { title: "Week 3 — Grounding: RAG", comps: ["L3.AUTO.N8N", "L4.DOMAIN.SOLUTION"],
    human_spine: "Refine the empathy map from what the data reveals.",
    milestone: { title: "Answers accurately from the stakeholder's own data", definition_of_done: "A RAG system answers correctly over the stakeholder's real documents." },
    lessons: [
  ...
  { title: "Week 4 — RAG Quality & Evaluation", comps: ["L4.DOMAIN.MEASUREMENT"],
    human_spine: "Keep the solution pointed at the real user as quality improves.",
    milestone: { title: "Eval harness + measurably improved RAG", definition_of_done: "A test set + LLM-as-judge shows a measurable accuracy improvement." },
    lessons: [
  ...
  { title: "Week 5 — Agents", comps: ["L2.CLAUDE.WORKFLOWS", "L3.AUTO.N8N"],
    human_spine: "Re-map stakeholders as the solution's scope grows.",
    milestone: { title: "Solution becomes an agent completing a real multi-step task", definition_of_done: "An agent completes a real multi-step task end to end." },
    lessons: [
  ...
  { title: "Week 6 — Deployment Fundamentals", comps: ["L3.AUTO.DELIVERY"],
    human_spine: "Keep cost + latency honest — a deployed tool a real user can reach.",
    milestone: { title: "Deployed to production — a live URL", definition_of_done: "The one solution runs at a live URL, not a notebook." },
    lessons: [
  ...
  { title: "Week 7 — Empathy, Adoption & the Last Mile", comps: ["XC.COMMUNICATION", "XC.OBJECTION"],
    human_spine: "Finalise the Stakeholder & Empathy Dossier; polish README + demo.",
    milestone: { title: "Adoption plan + stakeholder sign-off", definition_of_done: "An adoption plan exists and the stakeholder has signed off; dossier complete." },
    lessons: [
  ...
  { title: "Week 8 — Capstone: Complete, Hand Over & Defend", comps: ["L4.DOMAIN.SOLUTION", "XC.INTEGRITY"],
    human_spine: "Hand over the one solution to the real stakeholder and defend it.",
    milestone: { title: "Solution completed, handed over, and defended", definition_of_done: "The one business solution is finished, handed over to the stakeholder, and defended in a demo." },
    lessons: [
...
async function main() {
  await seedCourse("FDE — Forward Deployed Engineer (8 weeks)", "Complete, deploy and hand over one real AI business solution — production-ready from day one.", FDE);
}
